...
public class ReusableMethods extends AmazonDriver {
	...
	public static void enterText(WebElement obj, String textVal,String objName) throws IOException{
		...
		if(obj.isDisplayed()){
			...
			Update_Report(	"Pass: ",       objName+ " field  is entered ","SendKey",  driver);
			
		}else{
			Update_Report(	"fail: ", "SendKey",       objName+ " field  is missing check your app ", driver);
	...
	public static String startReport(String scriptName, String ReportsPath , String bname) throws IOException{
...
public static String screenshot(WebDriver dr) throws IOException{
		...
		String  ss1Path = "/Users/peter/ReportLogs/AmazonRepo/"+ str_time+".png";
